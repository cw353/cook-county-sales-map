/*
 * Original version by Yasunori Kirimoto (https://github.com/dayjournal/Leaflet.Control.Opacity/)
 * Modifications by Claire Wagner, adapted from TomazicM's edits at https://gis.stackexchange.com/a/421662
 */
...
L.Control.Opacity = L.Control.extend({
    ...
    _addItem: function (obj) {
        ...
        if (obj.overlay) {
            ...
            input.min = 0;
            input.max = 100;
            input.value = this.options.initialOpacity ? this.options.initialOpacity * 100 : obj.layer.options.opacity * 100;
        } else {
        ...
        input.addEventListener('input', (event) => {
            ...
            if (this.options.updateOpacity) {
                this.options.updateOpacity(layer, rgValue / 100);   
